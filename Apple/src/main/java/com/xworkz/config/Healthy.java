...
public class Healthy extends AbstractAnnotationConfigDispatcherServletInitializer implements WebMvcConfigurer {
	...
	protected Class<?>[] getServletConfigClasses() {
		...
		return new Class[] {HealthyConfiguration.class};
	}
